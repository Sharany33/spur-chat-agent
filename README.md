...
- Copy and tone are aligned with Spur’s product messaging but adapted for an operator-facing context
- UX details like typing indicators, disabled send states, and auto-scroll were added for realism
- The UI is calm and functional, reflecting Spur’s “boring but makes money” philosophy
- The goal was to build something believable and extensible, not flashy.

## 🕒️ If I Had More Time…
- Add pagination or “load earlier messages” for long conversations
